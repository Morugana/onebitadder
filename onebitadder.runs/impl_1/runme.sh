...
HD_PWD='C:/Users/yanhan/Vivado_lab/onebitadder/onebitadder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log subtractor.vdi -applog -m64 -messageDb vivado.pb -mode batch -source subtractor.tcl -notrace
