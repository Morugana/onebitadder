...
HD_PWD='C:/Users/yanhan/Vivado_lab/onebitadder/onebitadder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log subtractor.vds -m64 -mode batch -messageDb vivado.pb -notrace -source subtractor.tcl
